 ...
 */
@Deprecated
public class Login_obsoleto {

    private static org.apache.log4j.Logger log = Logger.getLogger(Login_obsoleto.class);
    ...
    public Login_obsoleto() {
    }

    @Deprecated
    public boolean Login_obsoleto() {
        ...
        try {
            ...
            // password = Integracion_SDtoSF_local.LOCAL_JZAVALA ? arcProp.getProp().getProperty("CAServiceDesk_password_TPE") : AlgoritmoAES.dencDatos(arcProp.getProp().getProperty("CAServiceDesk_password_TPE"));
